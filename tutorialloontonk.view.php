 ...
 * particular, you can set here the values of variables elements defined in tutorialloontonk_tutorialloontonk.tpl (elements
...
class view_tutorialloontonk_tutorialloontonk extends game_view
{
    protected function getGameName()
    {
  	...
  	{		
        ...
        $this->page->begin_block( "tutorialloontonk_tutorialloontonk", "square" );
        ...
        */
        ...
        $this->page->begin_block( "tutorialloontonk_tutorialloontonk", "myblock" );
